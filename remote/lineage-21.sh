...
REPO_URL="-u https://github.com/LineageOS/android.git -b lineage-21.0 $REPO_PARAMS"
...
git revert --no-edit 8d8081c2c9efc541964746f72d3c95202c4c56fa # Squiggly media progress bar, depends on ROM
