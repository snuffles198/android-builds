...
cat strings.xml.backup.orig.txt | sed -e 's#RisingOS-Revived/official_devices/sixteen/OTA/device/GAPPS/{device}.json#Joe7500/Builds/main/rising-rev-8-gapps-chime.json#g' > strings.xml.new.txt
mv strings.xml.new.txt strings.xml.backup.orig.txt
cat strings.xml.backup.orig.txt | sed -e 's#RisingOS-Revived/official_devices/sixteen/OTA/device/VANILLA/{device}.json#Joe7500/Builds/main/rising-8-rev-vanilla-chime.json#g' > strings.xml.new.txt
mv strings.xml.new.txt strings.xml.backup.orig.txt
