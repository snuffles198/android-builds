...
REPO_URL="-u https://github.com/RisingOS-Revived/android -b qpr2 $REPO_PARAMS"
...
echo 'RISING_MAINTAINER := Joe'  >> lineage_chime.mk
echo 'PRODUCT_BUILD_PROP_OVERRIDES += RisingChipset="Chime"' >> lineage_chime.mk 
echo 'PRODUCT_BUILD_PROP_OVERRIDES += RisingMaintainer="Joe"' >> lineage_chime.mk
