...
PACKAGE_NAME=lineage-19
VARIANT_NAME=user
BUILD_TYPE=vanilla
DEVICE_BRANCH=lineage-19
VENDOR_BRANCH=lineage-19
XIAOMI_BRANCH=lineage-19.1
GENOTA_ARG_1="lineage"
GENOTA_ARG_2="20"
REPO_URL="-u https://github.com/LineageOS/android.git -b lineage-19.1 --git-lfs"
...
git clone https://github.com/Joe7500/vendor_xiaomi_chime_legacy.git -b $VENDOR_BRANCH vendor/xiaomi/chime ; check_fail
...
chmod a-x sf
chmod go-rwx sf
rsync --log-file=rsync.log -avP -e 'ssh -i ./sf -o StrictHostKeyChecking=accept-new -o BatchMode=yes' $GO_FILE $SF_URL
